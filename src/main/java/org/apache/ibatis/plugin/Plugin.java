...
import com.xiangtai.framework.core.plugin.PagePlugin;
import com.xiangtai.framework.core.plugin.PageView;
import com.xiangtai.framework.core.util.Common;
import com.xiangtai.framework.core.util.EhcacheUtils;
...
public class Plugin implements InvocationHandler {
	...
	public static Object wrap(Object target, org.apache.ibatis.plugin.Interceptor interceptor) {
		...
		if (interfaces.length > 0) {
			return Proxy.newProxyInstance(type.getClassLoader(), interfaces, new org.apache.ibatis.plugin.Plugin(target,
