package com.xiangtai.framework.core.shiro;
...
import com.xiangtai.framework.core.mapper.RoleMapper;
    ...
    protected AuthorizationInfo doGetAuthorizationInfo(PrincipalCollection principalCollection) {
        ...
        if (loginName != null) {
            ...
            if (null != list && list.size() > 0) {
                Iterator<RoleFormMap> it = list.iterator();
                Set<String> roles = new HashSet<>();
                while (it.hasNext()) {
                    RoleFormMap n = it.next();
                    roles.add(n.getStr("roleKey"));
                }
                info.setRoles(roles);
            }
