...
import com.xiangtai.framework.core.annotation.TableSeg;
...
public class ConfigUtils {
     ...
     * @param baseMapper
     */
    public void initTableField(ResourcesMapper baseMapper) {
        // 记录总记录数
        ...
        try {
            ...
            String packageName = "com.xiangtai.framework.core.entity";
            String packageName2 = "com.xiangtai.biz.entity";
            // List<String> classNames = getClassName(packageName);
            List<String> classNames = ClassUtil.getClassName(packageName, true);//true包含子目录
            classNames.addAll(ClassUtil.getClassName(packageName2, true));
            String tabs = "";
