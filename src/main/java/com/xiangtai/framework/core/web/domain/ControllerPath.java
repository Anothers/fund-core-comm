package com.xiangtai.framework.core.web.domain;

import com.xiangtai.framework.core.dao.constants.PagePrefix;
import com.xiangtai.framework.core.utils.BeanUtils;
import com.xiangtai.framework.core.utils.StringEx;
import org.apache.commons.lang3.StringUtils;

/**
 * Controller路径构建起
 * @author ZhangDe
 * @date 2015年9月26日下午3:11:43
 */
public class ControllerPath {
	...
	/**
	 * 获取显示页面路径  
	 * @return String "biz/dictionary/viewDictionary"
	 */
	...
	/**
	 * 显示列表路径
	 * @return String "biz/dictionary/listDictionary"
	 */
	...
	/**
	 * 获取类名路径信息，例如：SysDictionary 则返回  "biz/dictionary/"
